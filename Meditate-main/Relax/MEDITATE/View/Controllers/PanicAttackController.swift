...
class PanicAttackController: UIViewController {
  ...
  lazy var pauseIcon: UIButton = {
    ...
    let urlString = Bundle.main.path(forResource: AppSounds.calmOcean.resource, ofType: AppSounds.mp3.resource)
    @objc func playSong() {
