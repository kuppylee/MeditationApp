...
class OverthinkingController: UIViewController {
  ...
  lazy var pauseIcon: UIButton = {
    ...
    let urlString = Bundle.main.path(forResource: AppSounds.waterStream.resource, ofType: AppSounds.mp3.resource)
    @objc func playSong() {
