...
class BadDreamsController: UIViewController {
  ...
  lazy var pauseIcon: UIButton = {
    ...
    let urlString = Bundle.main.path(forResource: AppSounds.piano.resource, ofType: AppSounds.mp3.resource)
    @objc func playSong() {
