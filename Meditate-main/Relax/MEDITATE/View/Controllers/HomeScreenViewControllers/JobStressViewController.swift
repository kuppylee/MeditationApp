...
class JobStressViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
  let cards: [JobStressCard] = {
    let firstCard = JobStressCard(title: "Meditation Break", time: "10 mins", imageName: "Meditation Break")
    let secondCard = JobStressCard(title: "Deep Breathing", time: "25 mins", imageName: "Deep Breathing")
    let thirdCard = JobStressCard(title: "Stressful Times", time: "45 mins", imageName: "Stressfull Times")
